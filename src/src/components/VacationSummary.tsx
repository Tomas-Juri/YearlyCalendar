    ...
    <div className="px-12 pb-24">
      <div className="">
        ...
        <table className="bg-white table-fixed">
          <thead>
            <tr>
              <th className="px-4 py-2 border border-gray-300 text-center text-gray-700 font-medium w-1/3">
                Available
              </th>
              <th className="px-4 py-2 border border-gray-300 text-center text-gray-700 font-medium w-1/3">
                Used
          ...
          <tbody>
            <tr>
              <td className="px-4 py-2 border border-gray-300 text-center text-gray-700 font-medium w-1/3">
                <VacationAllowanceEditor />
              </td>
              <td className={`px-4 py-2 border border-gray-300 text-center font-semibold text-lg w-1/3 ${
