...
const testScenarios = [
  ...
  },
  {
    ...
    events: [
      { from: new Date(2025, 5, 7), to: new Date(2025, 5, 8), fromType: "Full day", toType: "Full day" }
    ],
    expected: 0
  },
  {
    ...
    events: [
      { from: new Date(2025, 11, 24), to: new Date(2025, 11, 24), fromType: "Full day", toType: "Full day" }
    ],
    expected: 0
  },
  {
    ...
    events: [
      { from: new Date(2025, 5, 9), to: new Date(2025, 5, 15), fromType: "Full day", toType: "Full day" }
    ],
    expected: 5
  },
  {
  ...
  },
  {
    ...
    events: [
      { from: new Date(2025, 11, 22), to: new Date(2026, 0, 3), fromType: "Full day", toType: "Full day" }
    ],
    expected: 6
  },
  {
    ...
    events: [
      { from: new Date(2025, 5, 9), to: new Date(2025, 5, 11), fromType: "1st Half", toType: "2nd Half" }
    ],
    expected: 2
  },
  {
    ...
    events: [
      { from: new Date(2025, 6, 1), to: new Date(2025, 6, 31), fromType: "Full day", toType: "Full day" }
    ],
    expected: 23
  }
];
